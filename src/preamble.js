...
var wasm_download = 0;
var wasm_size = 0;
Module['GetWasmSize'] = function () { return wasm_size; }
Module['GetWasmDownloaded'] = function () { return wasm_download; }
        ...
        typeof fetch === 'function') {
            ...
            while (!dl_done) {
                ...
                if (done) {
                    ...
                    wasm_download += value.length;
                }
            }
            var result = WebAssembly.instantiateStreaming(new Response(streams[1],
                {headers: { "Content-Type": mime}}), info);
